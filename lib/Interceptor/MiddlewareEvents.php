...
namespace FicoscorePeru\Client\Interceptor;
...
use \FicoscorePeru\Client\Interceptor\KeyHandler;
use \FicoscorePeru\Client\Interceptor\MyLogger;
use \FicoscorePeru\Client\Model\Errors;
use \FicoscorePeru\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(\FicoscorePeru\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new \FicoscorePeru\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new \FicoscorePeru\Client\Model\Errores(["errors" => [$error]]);
